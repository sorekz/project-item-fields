...
describe('action', () => {
  ...
  it('read fields from test project', async () => {
    ...
    expect(setOutputMock).toBeCalledWith('TEST_TEXT', 'Some text')
    expect(setOutputMock).toBeCalledWith('TEST_NUMBER', 42)
    expect(setOutputMock).toBeCalledWith('TEST_DATE', '2023-10-18')
